...
extension PlaySoundViewController: AVAudioPlayerDelegate {
    ...
    func setPlayButtonsEnabled(_ enabled: Bool) {
        slowOutlet.isEnabled = enabled
        highPichOutlet.isEnabled = enabled
        rabbitOutlet.isEnabled = enabled
        lowPitchOutlet.isEnabled = enabled
        echoOutlet.isEnabled = enabled
        reverbOutlet.isEnabled = enabled
    }
